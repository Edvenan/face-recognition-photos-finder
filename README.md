...
Well, the purpose of this project is to automate such task so that by training a Machine Learning model with tpictures of the target person, the model finds for you all those photos containing such person.
